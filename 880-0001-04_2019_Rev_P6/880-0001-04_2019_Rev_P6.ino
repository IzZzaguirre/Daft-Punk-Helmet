...
//      delay(100);                  // waits for a second    
      ...
      a=12,b=2,c=1,d=1,e=1,f=1, g=2,h=12;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=48,b=64,c=128,d=128,e=128,f=128,g=64,h=48;
      RotateLeftEven(a,b,c,d,e,f,g,h); 
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~1          
      a=2,b=1,c=1,d=1,e=1,f=2,g=12,h=48;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=64,b=128,c=128,d=128,e=128,f=64,g=48,h=12;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~2   
      a=1,b=1,c=1,d=1,e=2,f=12,g=48,h=64;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=128,b=128,c=128,d=128,e=64,f=48,g=12,h=2;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~3         
      a=1,b=1,c=1,d=2,e=12,f=48,g=64,h=128;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=128,b=128,c=128,d=64,e=48,f=12,g=2,h=1;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4    
      a=1,b=1,c=2,d=12,e=48,f=64,g=128,h=128;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=128,b=128,c=64,d=48,e=12,f=2,g=1,h=1;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~5         
      a=1,b=2,c=12,d=48,e=64,f=128,g=128,h=128;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=128,b=64,c=48,d=12,e=2,f=1,g=1,h=1;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~6      
      a=2,b=12,c=48,d=64,e=128,f=128,g=128,h=128;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=64,b=48,c=12,d=2,e=1,f=1,g=1,h=1;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~7          
      a=12,b=48,c=64,d=128,e=128,f=128,g=128,h=64;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
      a=48,b=12,c=2,d=1,e=1,f=1,g=1,h=2;
      RotateLeftEven(a,b,c,d,e,f,g,h);   
      delay(time);//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8  
      a=48,b=64,c=128,d=128,e=128,f=128,g=64,h=48;
      RotateLeftOdd(a,b,c,d,e,f,g,h); 
   ...
   void RotateLeftOdd(int a,int b, int c, int d, int e, int f, int g, int h){          
  ...
  void RotateLeftEven(int a,int b, int c, int d, int e, int f, int g, int h){     
